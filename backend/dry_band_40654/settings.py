"""
Django settings for dry_band_40654 project.
...
ROOT_URLCONF = 'dry_band_40654.urls'
...
WSGI_APPLICATION = 'dry_band_40654.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dry_band_40654 API",
    "DESCRIPTION": "API documentation for dry_band_40654 App",
    "VERSION": "v1",
}
